...
python ${PROJECT_DIR}/../eval.py \
    ...
    --model_arch resnet18 \
    --classes 27 \
    --ckpt_path /home/tuyanlun/code/mindspore_r1.0/hpa/AVA-hpa-train-resnet18-27-217/checkpoint-20210115-133112/AVA-20_4590.ckpt\
    --data_dir /home/tuyanlun/code/mindspore_r1.0/hpa_dataset/hpa \
    --save_eval_path ./217_27_no_pretrain/